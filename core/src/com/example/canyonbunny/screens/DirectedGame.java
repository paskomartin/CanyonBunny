...
public class DirectedGame implements ApplicationListener {
    ...
    public void setScreen(AbstractGameScreen screen, ScreenTransition screenTransition) {
        ...
        if (!init) {
            currFbo = new FrameBuffer(Pixmap.Format.RGBA8888, w, h, false);
            nextFbo = new FrameBuffer(Pixmap.Format.RGBA8888, w, h, false);
        ...
        nextScreen.pause();
        Gdx.input.setInputProcessor(null);  // disable inputs
